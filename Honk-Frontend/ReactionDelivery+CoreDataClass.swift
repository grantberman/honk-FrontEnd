...
public class ReactionDelivery: NSManagedObject, Codable{
    ...
    required convenience public init (from decoder: Decoder) throws {
        guard let contextUserInfoKey = CodingUserInfoKey.context,
            ...
            let entity = NSEntityDescription.entity(forEntityName: "ReactionDelivery", in: managedObjectContext) else { fatalError ("Failed to decode reaction delivery")}
